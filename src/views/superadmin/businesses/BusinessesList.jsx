...
const headCells = [
    ...
    },
    {
        ...
        numeric: true,
        label: 'Bedriftens Forretningsnummer',
        align: 'left'
    },
    {
        id: 'phone-number',
...
const BusinessesList = () => {
    ...
    return (
        <MainCard title="Bedrifter" content={false}>
            <CardContent>
                <Grid container justifyContent="space-between" alignItems="center" spacing={2}>
                    ...
                    <Grid item xs={12} sm={6} sx={{ textAlign: 'right' }}>
                        <Tooltip title="Add">                            
                            <Button component={Link} to="/superadmin/businesses/add" variant="contained" startIcon={<AddIcon />} size="large">
                                Ny Virksomhet
                            </Button>                            
                        </Tooltip>
                            ...
                            .map((row, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell align="left">{row.companyBusinessNumber}</TableCell>
                                        <TableCell align="left">{row.telephoneNumber}</TableCell>
