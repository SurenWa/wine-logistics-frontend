...
const ReceptionList = () => {
    ...
    return (
        <MainCard title="Varetelling" content={false}>
            ...
            <CardContent>
                <Grid container justifyContent="space-between" alignItems="center" spacing={2}>
                    ...
                    <Grid item xs={12} sm={6} sx={{ textAlign: 'right' }}>                       
                        ...
                        <Tooltip title="Add">
                            <Button component={Link} to="/admin/stockcount/add" variant="contained" startIcon={<AddIcon />} size='medium'>
                                legge til
                            </Button>
                        </Tooltip>                                               
                    </Grid>
                            ...
                            .map((row, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <StyledTableCell align="left"><PictureAsPdfSharpIcon />{row.file}</StyledTableCell>
