...
import AddSupplierModal from './AddProducerModal';
...
const ProducersList = () => {
    ...
    return (
        <MainCard title="Leverandører" content={false}>
            <CardContent>
                <Grid container justifyContent="space-between" alignItems="center" spacing={2}>
                    ...
                    <Grid item xs={12} sm={6} sx={{ textAlign: 'right' }}>
                        ...
                        <Tooltip title="Add">                            
                            <Button onClick={handleClickOpen} variant="contained" startIcon={<AddIcon />} size="medium">
                                Ny produsent
                            </Button>                            
                        </Tooltip>                        
                    </Grid>                   
            ...
            <AddSupplierModal fullScreen={fullScreen}  open={open} onClose={handleClose} />
