...
const StockOverview = () => {
    ...
    return (
        <MainCard title="Lageroversikt" content={false}>        
            <CardContent>
                        ...
                        <Grid item xs={12} md={4}>
                            <Stack>
                                ...
                                <Select
                                    ...
                                    name="orderStatus"                                        
                                >
                                    <MenuItem value="pending">Kategorier</MenuItem>
                                    <MenuItem value="refund">Kategorier</MenuItem>
                                    <MenuItem value="paid">Kategorier</MenuItem>
                                </Select>
                            </Stack>
                        </Grid>
                        {/* <Grid item xs={12} md={4}>
                            ...
                            .map((row, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <StyledTableCell align="left">{row.inventoryBalance}</StyledTableCell>
