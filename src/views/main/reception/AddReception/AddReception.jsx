...
import AddReceptionDataTable from './AddReceptionDataTable';
                ...
                <MainCard title="Legg til brukere">
                    <Grid container spacing={4} alignItems="center">
                        ...
                        <Grid item xs={12} lg={4}>
                            ...
                            <TextField required fullWidth placeholder="Enter leverandør" />
                        </Grid>
                        <Grid item xs={12} lg={4}>
                            <InputLabel>Ref</InputLabel>
                            <TextField required fullWidth placeholder="Enter Ref" />
                        </Grid>   
